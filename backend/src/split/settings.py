...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['http://*', 'http://localhost', 'http://localhost:7080', 'http://split.marktai.com', 'https://split.marktai.com']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'split.middleware.CsrfExemptSessionAuthentication',
    ),
